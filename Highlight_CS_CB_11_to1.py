...
app.layout = html.Div([
    ...
    html.Div(id="log2"),
    html.Div(id="log"),
    html.Button("Reset View", id="btn", n_clicks=0),
...
#     """
#     function(selectedColors, nClicks, geojsonData, bounds) {
#         return window.dash_clientside.my_filtering.updateGeoJSON(selectedColors, nClicks, geojsonData, bounds);
#     }
#     """,
#     Output("test_map", "data"),
#     [Input("selected-legend-items", "data"),  # Pass the selected colors
#      Input("btn", "n_clicks")],               # Pass the button click count
#     [State("test_map", "data"),               # Pass the current GeoJSON data
#      State("map", "bounds")]                  # Pass the map bounds
# )
...
#     print("Triggered ID:", ctx.triggered_id)  # Debugging
